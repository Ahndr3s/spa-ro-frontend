...
import { toggleSidePanel, toggleSearchPanel } from "../store/interactivePanels";
import {
  onSetActiveCategory,
  ...
  switch (props.cardType) {
    ...
    case 1:
      cardOption = (
        ...
        >
          <img className="product-card-img" src={props.img[0]} />
          ...
          <div className="product-card-footer">
            ...
            {props.size !== "T" && props.size === "1" ? (
              <>
                <h5 className="product-size">Tallas Infantiles</h5>
              </>
            ) : (
              props.size !== "T" &&
              props.size === "2" && (
                <>
                  <h5 className="product-size">Todas las Tallas</h5>
                </>
              )
            )}
    ...
    case 4:
      cardOption = (
        <div className="product-resume">
          <img className="product-resume-img" src={props.img[0]} />
    ...
    case 8:
      cardOption = (
        <div className="product-resume">
          <img className="product-resume-img" src={props.img[0]} />
          <div className="resume-card-info">
            <h4 className="product-res-title">{props?.title || ""}</h4>
            <h5 className="product-res-price">${props?.price || ""}</h5>
          </div>
        </div>
      );
      break;
